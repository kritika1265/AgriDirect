...
class RentToolsScreen extends StatefulWidget {
  const RentToolsScreen({Key? key}) : super(key: key);
...
class _RentToolsScreenState extends State<RentToolsScreen> with SingleTickerProviderStateMixin {
  ...
  List<ToolModel> get _filteredTools {
    if (_selectedCategory == 'All') return _availableTools;
  ...
  Widget _buildMyRentalsTab() {
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return _buildRentalCard(_myRentals[index]);
        },
      ),
    );
  }
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        AppConstants.formatDate(rental.startDate),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        AppConstants.formatDate(rental.endDate),
                        style: const TextStyle(fontWeight: FontWeight.w600),
                      ),
                    ],
                  ),
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('Contact owner to confirm rental details and pickup arrangements.'),
          ],
        ),
        actions: [
          TextButton(
