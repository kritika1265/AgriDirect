...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _saveSettings() async {
    ...
    await storageService.setBool('weather_alerts', _weatherAlerts);
    await storageService.setBool('disease_alerts', _diseaseAlerts);
    await storageService.setBool('market_price_alerts', _marketPriceAlerts);
    await storageService.setBool('dark_mode', _darkMode);
    await storageService.setString('selected_language', _selectedLanguage);
    await storageService.setString('temperature_unit', _temperatureUnit);
  }
